...
const faqs = [
  {
    question: "Как работи услугата Drink and Drive?",
  ...
  },
  {
    ...
    answer: "Приемаме плащане в брой или с банков превод (Revolut). Изберете най-удобния за вас начин!",
  },
];
